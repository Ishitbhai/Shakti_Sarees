<%@ Page Title="Edit Order" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminEditOrder.aspx.cs" Inherits="Shakti_Sarees.AdminEditOrder" %>

<asp:Content ID="Content1" ContentPlaceHolderID="AdminHead" runat="server">
    <link href="/Content/AdminOrderForm.css?v=2" rel="stylesheet" type="text/css" />
</asp:Content>
    ...
    <div class="ss-aof-viewport">
        <div class="ss-aof-card">
            ...
            <div class="ss-aof-section">
                ...
                <div class="ss-aof-row">
                    <div class="ss-aof-col">
                        ...
                        <asp:TextBox ID="txtCustomerEmail" runat="server" CssClass="ss-aof-input" Text="ishit@gmail.com"></asp:TextBox>
                    ...
                    <div class="ss-aof-col">
                        ...
                        <asp:TextBox ID="txtOrderDate" runat="server" CssClass="ss-aof-input" Text="01/08/2026"></asp:TextBox>
                ...
                <div class="ss-aof-row">
                    ...
                    <div class="ss-aof-col">
                        ...
                        <asp:TextBox ID="txtTotalAmount" runat="server" CssClass="ss-aof-input ss-input-readonly" ReadOnly="true" Text="36,204"></asp:TextBox>
                ...
                <div class="ss-prod-table-box">
                    ...
                    <div class="ss-prod-table-row">
                        ...
                        <div class="ss-pcol-price">
                            <asp:TextBox ID="txtItemPrice" runat="server" CssClass="ss-aof-input" Text="36,204"></asp:TextBox>
            ...
            <div class="ss-aof-actions">
                ...
                <asp:Button ID="btnEditOrder" runat="server" Text="Edit Order" CssClass="ss-aof-create-btn" OnClick="btnEditOrder_Click" />
            </div>
